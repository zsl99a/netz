...
pub struct LengthDelimitedFramed<I>
where
...
impl<I> LengthDelimitedFramed<I>
where
    I: AsyncRead + AsyncWrite + Send + Unpin,
{
...
impl<I> Stream for LengthDelimitedFramed<I>
where
    I: AsyncRead + AsyncWrite + Send + Unpin,
{
...
impl<I> Sink<Bytes> for LengthDelimitedFramed<I>
where
    I: AsyncRead + AsyncWrite + Send + Unpin,
{
